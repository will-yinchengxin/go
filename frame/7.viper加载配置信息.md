...
Viper是适用于Go应用程序的完整配置解决方案。它被设计用于在应用程序中工作，并且可以处理所有类型的配置需求和格式。[参考地址](https://github.com/spf13/viper/blob/master/README.md)
## 1.安装
...
#### 重点 ``Viper在后台使用github.com/mitchellh/mapstructure来解析值，其默认情况下使用mapstructuretag。``
> ### 序列化成字符串
